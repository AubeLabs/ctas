...
public class EgovArticleController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/cop/bbs/excelDownload.do")
	public ModelAndView excelDownload(@ModelAttribute("searchVO") BoardVO boardVO) throws Exception {

		List<BoardVO> goodsList = egovArticleService.selectNoticeArticleList(boardVO);
